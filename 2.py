...
class IceCreamStand(Restaurant):
    ...
    def add_flavor(self, flavor1):
        ...
        print(f"{flavor1} вкус добавлен в меню")
...
Restaurant1 = Restaurant("Душа Востока", "грузинская")
...
icecream_stand = IceCreamStand("Sweet Treats", "Ice Cream", "Московский проспект,71А", "10:00-21:00")
